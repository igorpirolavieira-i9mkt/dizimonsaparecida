  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-manto-dark to-manto">
      ...
      <header className="px-4 pt-8 pb-4 text-center text-white">
        ...
        <p className="text-dourado text-sm mt-1 font-semibold">Consulta de contribuições</p>
      ...
      <div className="px-4 pb-8 max-w-lg mx-auto space-y-4">
        ...
        {/* Card de busca */}
        <div className="bg-white rounded-2xl shadow-xl px-4 py-5 border-t-[3px] border-dourado">
            ...
            <button
              ...
              className={`px-4 py-3 rounded-xl font-bold text-white text-sm transition-all shrink-0
                ${carregando || busca.trim().length < 2
                  ...
                  : 'bg-manto hover:bg-manto-dark active:scale-95'}`}
            >
              {carregando ? '⏳' : 'Buscar'}
            </button>
          </form>
          ...
          {/* Lista de resultados */}
          {resultados.length > 0 && (
            <ul className="mt-3 border border-manto/20 rounded-xl overflow-hidden">
              {resultados.map(d => (
                <li key={d.id}>
                  <button
                    onClick={() => selecionarDizimista(d)}
                    className="w-full text-left px-4 py-3 hover:bg-manto/5 active:bg-manto/10 transition-colors border-b border-gray-50 last:border-0"
                  >
            ...
            {carregandoHistorico ? (
              ...
              <>
                ...
                <div className="bg-white rounded-2xl shadow-md overflow-hidden">
                  <div className="bg-manto text-white px-4 py-3 flex items-center justify-between border-b-[3px] border-dourado">
                    <div>
                  ...
                  <div className="px-4 py-4">
                    ...
                    <div className="flex gap-3 mt-3 text-xs text-gray-400">
                      <span className="flex items-center gap-1">
                        <span className="w-3 h-3 rounded bg-pago inline-block"></span> Pago
                      </span>
                      <span className="flex items-center gap-1">
                ...
                <button
                  onClick={limpar}
                  className="w-full py-3 rounded-xl font-semibold text-sm text-white border-2 border-dourado/40 hover:bg-dourado/10 transition-all"
                >
        ...
        {/* Rodapé */}
        <p className="text-center text-dourado/70 text-xs pb-4">
