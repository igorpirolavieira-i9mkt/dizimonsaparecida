      ...
      <div className="px-4 py-6 max-w-lg mx-auto space-y-4">
        ...
        <div className="bg-white rounded-2xl shadow-md border border-blue-100 overflow-hidden">
          ...
          <div className="bg-blue-700 text-white px-5 py-4 text-center">
            ...
            <p className="text-blue-200 text-xs mt-1">Chave PIX: {CHAVE_PIX}</p>
          </div>
          ...
          <div className="flex border-b border-gray-100">
            <button
              ...
              className={`flex-1 py-2.5 text-sm font-semibold transition-colors border-b-2
                ${mostrarQr ? 'text-blue-700 border-blue-700 bg-blue-50' : 'text-gray-400 border-transparent'}`}
            >
              📷 QR Code
            </button>
            <button
          ...
          <div className="px-5 py-6">
            {mostrarQr ? (
              ...
              <div className="space-y-3">
                <p className="text-xs font-semibold text-gray-500">Código PIX (copia e cola):</p>
            ...
            <button
              ...
              className={`mt-4 w-full py-4 rounded-xl font-bold text-base text-white shadow-md transition-all active:scale-95
                ${copiado ? 'bg-green-600' : 'bg-blue-700 hover:bg-blue-800'}`}
            >
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3">
          <p className="text-xs text-blue-700 font-semibold">ℹ️ PIX sem valor fixo</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-4 py-4 space-y-2">
          <p className="text-xs font-bold text-gray-400 uppercase tracking-wide">Como usar</p>
          {[
